...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'order_order', (
            ...
            ('shipping_method', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ...
            ('guest_email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
        ...
        db.create_table(u'order_ordernote', (
            ...
            ('note_type', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
        ...
        db.create_table(u'order_line', (
            ...
            ('partner_name', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ...
            ('partner_line_reference', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('partner_line_notes', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.create_table(u'order_orderdiscount', (
            ...
            ('offer_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=128, blank=True)),
            ('voucher_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('voucher_code', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=128, blank=True)),
    ...
    models = {
        ...
        u'order.order': {
            ...
            'currency': ('django.db.models.fields.CharField', [], {'default': "u'EUR'", 'max_length': '12'}),
        ...
        u'partner.stockrecord': {
            ...
            'partner_sku': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'price_currency': ('django.db.models.fields.CharField', [], {'default': "u'EUR'", 'max_length': '12'}),
