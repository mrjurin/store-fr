...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.basket'
        db.add_column(u'order_order', 'basket',
    ...
    def backwards(self, orm):
        # Deleting field 'Order.basket'
        db.delete_column(u'order_order', 'basket_id')
    ...
    models = {
        ...
        u'basket.basket': {
            ...
            'customer_cgv': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
