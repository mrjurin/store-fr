...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Basket.customer_cgv'
        db.add_column(u'basket_basket', 'customer_cgv',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Basket.customer_cgv'
        db.delete_column(u'basket_basket', 'customer_cgv')
