...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnonUserEmailFailure'
        db.create_table(u'customer_anonuseremailfailure', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dest', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ...
        db.send_create_signal(u'customer', ['AnonUserEmailFailure'])


    def backwards(self, orm):
        # Deleting model 'AnonUserEmailFailure'
        db.delete_table(u'customer_anonuseremailfailure')
    ...
    models = {
        ...
        u'customer.anonuseremailfailure': {
            'Meta': {'object_name': 'AnonUserEmailFailure'},
            'body': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dest': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'customer.email': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_error': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            'send_success': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
