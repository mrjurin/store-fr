...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Email.send_success'
        db.add_column(u'customer_email', 'send_success',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Email.send_success'
        db.delete_column(u'customer_email', 'send_success')
