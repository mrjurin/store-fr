...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Email'
        db.create_table(u'customer_email', (
        ...
        db.send_create_signal(u'customer', ['Email'])

        # Adding model 'CommunicationEventType'
        db.create_table(u'customer_communicationeventtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('oscar.models.fields.autoslugfield.AutoSlugField')(allow_duplicates=False, max_length=128, separator=u'_', blank=True, unique=True, populate_from='name', overwrite=False)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('category', self.gf('django.db.models.fields.CharField')(default=u'Order related', max_length=255)),
            ('email_subject_template', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('sms_template', self.gf('django.db.models.fields.CharField')(max_length=170, null=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'customer', ['CommunicationEventType'])

        # Adding model 'Notification'
        db.create_table(u'customer_notification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('location', self.gf('django.db.models.fields.CharField')(default='Inbox', max_length=32)),
            ('date_sent', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_read', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'customer', ['Notification'])

        # Adding model 'ProductAlert'
        db.create_table(u'customer_productalert', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('key', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=128, blank=True)),
        ...
        db.send_create_signal(u'customer', ['ProductAlert'])


    def backwards(self, orm):
        # Deleting model 'Email'
        db.delete_table(u'customer_email')

        # Deleting model 'CommunicationEventType'
        db.delete_table(u'customer_communicationeventtype')

        # Deleting model 'Notification'
        db.delete_table(u'customer_notification')

        # Deleting model 'ProductAlert'
        db.delete_table(u'customer_productalert')
    ...
    models = {
        ...
        u'customer.email': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'emails'", 'to': u"orm['auth.User']"})
        },
        ...
        u'customer.productalert': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '128', 'blank': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['catalogue.Product']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'Active'", 'max_length': '20'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'alerts'", 'null': 'True', 'to': u"orm['auth.User']"})
        }
    }
